...
// Import new modules
const { getEnvironmentVCSData, addVCSMetadata } = require('./lib/git.helper');
...
module.exports.track = async (args = {}) => {
  ...
  } else if (args.hasOwnProperty('customResourceAttributes') && typeof args.customResourceAttributes === 'object') {
    config.customResourceAttributes = args.customResourceAttributes;
  } else {
    config.customResourceAttributes = {};
  }
  ...
  addVCSMetadata(_resourceAttributes);
